# -*- coding: utf-8 -*-
"""
Created on Thu Jan 17 17:58:38 2019
...
def db_append(date_str):
    ...
    sql= 'delete from Future_Daily where TradingDay = '+date_str
    con.execute(sql)
    con.commit()    
    ...
    future_daily.to_sql(csvname,con,if_exists = 'append',index = True)
